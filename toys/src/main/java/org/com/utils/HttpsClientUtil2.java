...
import com.sky.support.utils.http.WechatX509TrustManager;
...
public class HttpsClientUtil2 {
    ...
    private static Logger logger = LoggerFactory.getLogger(com.HttpsClientUtil2.support.utils.http.HttpsClientUtil.class);

    private HttpsClientUtil2() {}
    ...
    public static String sendPostSSLRequest(String reqURL, Map<String, String> params,
        ...
        HttpClient httpClient = new DefaultHttpClient();
        X509TrustManager xtm = new com.sky.support.utils.http.WechatX509TrustManager();
        try {
...
//            logger.debug("响应内容: " + responseContent);
    ...
    public static String sendPostRequestByJava(String reqURL, String sendData) {
        if (reqURL.startsWith("https")) {
            return HttpsClientUtil2.sendPostRequest(reqURL, sendData, true);
        } else {
